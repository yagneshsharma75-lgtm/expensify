const CACHE='expensify-v4';
const ASSETS=['./','./index.html','./login.html','./dashboard.html','./transactions.html','./analytics.html','./settings.html','./style.css','./script.js','./manifest.json'];
